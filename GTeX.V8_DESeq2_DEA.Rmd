...
coldata$AGE = factor(coldata$AGE, c('20-29', '30-39', '40-49', '50-59', '60-69', '70-79')) # age is set in range in this dataset
...
dds <- DESeq(dds)
resultsNames(dds) 
GTex.Res.Age <- results(dds, name="ageOfDeath", alpha = 0.05)
